...
specs.T_r = 1;   % Periode of referance signal if a sin wave 
...
% Makes the combined state space of plant and refferance 
math.A_12 = [0 0;0 0; plant_SS.C];
...
math.eig_val = [math.x1 + 1i*math.y1, math.x1 - 1i*math.y1, math.x3 + 1i*math.y3, math.x3 - 1i*math.y3, -specs.W_n];

% calculation of feedback via acker and place
feedback.K= acker(hat_SS.A, hat_SS.B, math.eig_val);
