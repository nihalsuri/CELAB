...
typedef struct {
  real_T Highpassfilterrealderivative_CSTATE[2];
                                 /* '<S1>/High-pass filter (real derivative)' */
  real_T TransferFcn_CSTATE[3];        /* '<S2>/Transfer Fcn' */
} X_realtime44_T;
...
typedef struct {
  boolean_T Highpassfilterrealderivative_CSTATE[2];
                                 /* '<S1>/High-pass filter (real derivative)' */
  boolean_T TransferFcn_CSTATE[3];     /* '<S2>/Transfer Fcn' */
} XDis_realtime44_T;
...
struct P_realtime44_T_ {
  ...
  struct_LYXsnuLmZkcUvicgq9G2LH filt;  /* Variable: filt
                                        ...
                                        */
  struct_bqXfskVfKnpGQWgWt5iSAG sIn;   /* Variable: sIn
                                        * Referenced by:
                                        *   '<Root>/Constant'
                                        *   '<Root>/Sine Wave'
                                        *   '<Root>/Step'
  ...
  real_T Step_Y0;                      /* Expression: 0
                                        * Referenced by: '<Root>/Step'
                                        */
  real_T Gain_Gain[2];             /* Expression:  [feedback.K(4) feedback.K(5)]
 ...
 *
 * '<Root>' : 'realtime44'
 * '<S1>'   : 'realtime44/Simple State Observer2'
 * '<S2>'   : 'realtime44/State-space Controller (BB)2'
