...
MODEL                := realtime44
MODULES              := realtime44_data.c realtime44_tgtconn.c rt_nonfinite.c
MAKEFILE             := realtime44.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := realtime44_ref.rsp
...
# additional includes
REQ_INCLUDES += ;$(WQ)C:/Users/ControlSystemsUser/Desktop/CELAB1/Clean_for_Lab/lab1_param_estim$(WQ);$(WQ)C:/Users/ControlSystemsUser/Desktop/CELAB1/Clean_for_Lab/lab1_param_estim/realtime44_sldrt_win64$(WQ);$(WQ)$(MATLAB_ROOT)/extern/include$(WQ);$(WQ)$(MATLAB_ROOT)/simulink/include$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src/ext_mode/common$(WQ);$(WQ)$(MATLAB_ROOT)/toolbox/coder/rtiostream/src$(WQ)
