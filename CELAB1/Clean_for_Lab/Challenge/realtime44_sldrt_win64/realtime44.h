...
struct P_realtime44_T_ {
  struct_8LnTg2HasR61N4e63tMdJ sens;   /* Variable: sens
                                        ...
                                        */
  struct_ItuxLz2WsylTYeqiMMlbFH feedback;/* Variable: feedback
                                          * Referenced by:
  ...
  struct_LYXsnuLmZkcUvicgq9G2LH filt;  /* Variable: filt
                                        ...
                                        */
  struct_x9ApqVPVg1f2Cv2VABU5pG sIn;   /* Variable: sIn
 ...
 * '<S2>'   : 'realtime44/Simple State Observer1'
 * '<S3>'   : 'realtime44/State-Space Robust Anti-Windup'
