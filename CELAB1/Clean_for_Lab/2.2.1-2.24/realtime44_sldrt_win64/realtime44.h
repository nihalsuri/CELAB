...
typedef struct {
  ...
  real_T InputfeedforwardgainNu;       /* '<S3>/Input feedforward gain (Nu)' */
  real_T Integratorfeedback;           /* '<S3>/Integrator feedback' */
  real_T StatefeedforwardgainNx[2];    /* '<S3>/State feedforward gain(Nx)' */
...
typedef struct {
  real_T Highpassfilterrealderivative_CSTATE[2];
                                 /* '<S2>/High-pass filter (real derivative)' */
...
/* State disabled  */
typedef struct {
  boolean_T Highpassfilterrealderivative_CSTATE[2];
                                 /* '<S2>/High-pass filter (real derivative)' */
...
struct P_realtime44_T_ {
  struct_8LnTg2HasR61N4e63tMdJ sens;   /* Variable: sens
                                        ...
                                        */
  struct_fNvLKrmGPjNwFpotE81xaF feedback;/* Variable: feedback
                                          * Referenced by:
                                          ...
                                          */
  struct_3PxRKnguvZJWZpmBEPjwDC sIn;   /* Variable: sIn
                                        * Referenced by: '<S1>/Vector'
                                        */
  struct_LYXsnuLmZkcUvicgq9G2LH filt;  /* Variable: filt
 ...
 *
 * '<Root>' : 'realtime44'
 * '<S1>'   : 'realtime44/Repeating Sequence Stair'
 * '<S2>'   : 'realtime44/Simple State Observer'
 * '<S3>'   : 'realtime44/State-space Controller (Robust)'
 * '<S4>'   : 'realtime44/Subsystem'
 * '<S5>'   : 'realtime44/Repeating Sequence Stair/LimitedCounter'
 * '<S6>'   : 'realtime44/Repeating Sequence Stair/LimitedCounter/Increment Real World'
 * '<S7>'   : 'realtime44/Repeating Sequence Stair/LimitedCounter/Wrap To Zero'
 */
#endif                                 /* realtime44_h_ */
