...
sOut.omeg.p = timeseries(out_omega_motor.signals.values(find(idx.staircase_p)),...
                         out_omega_motor.time(find(idx.staircase_p)));
sOut.curr.p = timeseries(out_i_a.signals.values(find(idx.staircase_p)),...
                         out_i_a.time(find(idx.staircase_p)));

sOut.omeg.n = timeseries(out_omega_motor.signals.values(find(idx.staircase_n)),...
                         out_omega_motor.time(find(idx.staircase_n)));
sOut.curr.n = timeseries(out_i_a.signals.values(find(idx.staircase_n)),...
                         out_i_a.time(find(idx.staircase_n)));
