...
%% Calculating K and gains for controller 
...
feedback.K= acker(plant.sys_d.A, plant.sys_d.B, eigP.values_d);
...
% calculation of feedback via acker
feedback.K2= acker(plant.sys_d2.A, plant.sys_d2.B, eigP.values_d2);
...
obs.gamma02 = [plant.sys_d2.B(2)-obs.L2*plant.sys_d2.B(1) ...
             obs.phi02*obs.L2+plant.sys_d2.A(2,1)-obs.L2*plant.sys_d2.A(1,1)]; 
obs.H02 = [0 ; 1]; 
obs.J02 = [0 1
         0 obs.L2;];
...
% calculation of feedback via acker
feedback.K3= acker(plant.sys_d3.A, plant.sys_d3.B, eigP.values_d3);

% calculation of Nx(state feedforward gain), Nu (input feedforward gain)
plant.gains3 = ([plant.sys_d3.A-eye(2), plant.sys_d3.B; plant.sys_d3.C, plant.sys_d3.D])\[0;0;1];
feedback.Nx3 = plant.gains3(1:2);
feedback.Nu3 = plant.gains3(3);
...
obs.gamma03 = [plant.sys_d3.B(2)-obs.L3*plant.sys_d3.B(1) ...
             obs.phi03*obs.L+plant.sys_d3.A(2,1)-obs.L3*plant.sys_d3.A(1,1)]; 
obs.H03 = [0 ; 1]; 
obs.J03 = [0 1
         0 obs.L3;];
