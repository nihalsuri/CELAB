...
static uint_T rtDataTypeSizes[] = {
  ...
  sizeof(struct_RpRKyQmph6vEfxzPyew3r),
  sizeof(struct_OWdElbvfJfRElaZMHZHwIE),
  sizeof(int32_T),
  sizeof(uint64_T),
  sizeof(int64_T),
  sizeof(uint_T),
...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&realtimemodel_B.Step), 0, 0, 11 }
  ,

  { (char_T *)(&realtimemodel_DW.DiscreteTimeIntegrator_DSTATE), 0, 0, 2 },

  { (char_T *)(&realtimemodel_DW.EncoderInput_PWORK), 11, 0, 5 }
};
...
static DataTypeTransition rtPTransitions[] = {
  { (char_T *)(&realtimemodel_P.sens), 21, 0, 1 },

  { (char_T *)(&realtimemodel_P.obs3), 23, 0, 1 },

  { (char_T *)(&realtimemodel_P.feedback3), 22, 0, 1 },

  { (char_T *)(&realtimemodel_P.deg2rad), 0, 0, 11 },

  { (char_T *)(&realtimemodel_P.EncoderInput_Channels), 6, 0, 8 },

  { (char_T *)(&realtimemodel_P.Step_Time), 0, 0, 14 }
};
