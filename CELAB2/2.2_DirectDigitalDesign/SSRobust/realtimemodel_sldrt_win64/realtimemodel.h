...
typedef struct {
  ...
  real_T ZeroOrderHold2;               /* '<S4>/Zero-Order Hold2' */
  real_T deg2rad2;                     /* '<S2>/deg2rad2' */
  real_T Integralgain;                 /* '<S2>/Integral gain' */
  real_T rpm2rads;                     /* '<S2>/rpm2rads' */
  real_T Saturation;                   /* '<S2>/Saturation' */
  real_T ZeroOrderHold1;               /* '<S4>/Zero-Order Hold1' */
  real_T TmpSignalConversionAtDiscreteStateSpaceInport1[2];
} B_realtimemodel_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  real_T DiscreteTimeIntegrator_DSTATE;/* '<S2>/Discrete-Time Integrator' */
  real_T DiscreteStateSpace_DSTATE;    /* '<S4>/Discrete State-Space' */
...
struct P_realtimemodel_T_ {
  struct_8LnTg2HasR61N4e63tMdJ sens;   /* Variable: sens
                                        ...
                                        */
  struct_OWdElbvfJfRElaZMHZHwIE obs3;  /* Variable: obs3
                                        * Referenced by: '<S4>/Discrete State-Space'
                                        */
  struct_RpRKyQmph6vEfxzPyew3r feedback3;/* Variable: feedback3
                                          * Referenced by:
  ...
  real_T DiscreteStateSpace_D[4];      /* Expression: zeros(2,2)
                                        * Referenced by: '<S4>/Discrete State-Space'
                                        */
  real_T DiscreteStateSpace_InitialCondition;/* Expression: 0
                                              * Referenced by: '<S4>/Discrete State-Space'
                                              */
  real_T undColofJ0_Gain[2];           /* Expression: obs3.J0(:,2)
 ...
 *
 * '<Root>' : 'realtimemodel'
 * '<S1>'   : 'realtimemodel/Subsystem3'
 * '<S2>'   : 'realtimemodel/Subsystem3/State-space Controller2'
 * '<S3>'   : 'realtimemodel/Subsystem3/Subsystem'
 * '<S4>'   : 'realtimemodel/Subsystem3/Subsystem3'
 */
