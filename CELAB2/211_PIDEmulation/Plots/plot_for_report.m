...
p.simout = [position1ms position10ms position50ms];  % Replace with your actual Simulink output variables
...
% Configure plot
grid on
legend(p.legends{:}, 'Location', 'southwest')  % Position legend at bottom-right corner
xlabel("Time [s]")
