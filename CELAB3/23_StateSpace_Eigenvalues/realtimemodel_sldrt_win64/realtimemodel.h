...
typedef struct {
  ...
  real_T HiddenBuf_InsertedFor_FeedbackController_at_inport_2;/* '<Root>/Step' */
...
typedef struct {
  ...
  int8_T FeedbackController_SubsysRanBC;/* '<Root>/Feedback Controller' */
  int8_T Average_SubsysRanBC;          /* '<S5>/Average' */
  boolean_T FeedbackController_MODE;   /* '<Root>/Feedback Controller' */
...
struct P_realtimemodel_T_ {
  struct_pXFintMJ2mOryotVT5lh5F feedback;/* Variable: feedback
                                          * Referenced by:
 ...
 * '<S2>'   : 'realtimemodel/Feedback Controller'
