...
typedef struct {
  ...
  real_T HiddenBuf_InsertedFor_FeedbackControllerNominal1_at_inport_2;/* '<Root>/Step' */
...
typedef struct {
  ...
  int8_T FeedbackControllerNominal1_SubsysRanBC;
                                     /* '<Root>/Feedback Controller Nominal1' */
  int8_T Average_SubsysRanBC;          /* '<S5>/Average' */
  boolean_T FeedbackControllerNominal1_MODE;
                                     /* '<Root>/Feedback Controller Nominal1' */
 ...
 * '<S2>'   : 'realtimemodel/Feedback Controller Nominal1'
