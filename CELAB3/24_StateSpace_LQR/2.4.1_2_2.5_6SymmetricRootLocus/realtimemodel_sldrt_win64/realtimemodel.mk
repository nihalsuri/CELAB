...
# additional includes
REQ_INCLUDES += ;$(WQ)Z:/windows_profile/Desktop/CELAB-master/CELAB-master/CELAB3/24_StateSpace_LQR/2.4.1_2_2.5_6SymmetricRootLocus$(WQ);$(WQ)Z:/windows_profile/Desktop/CELAB-master/CELAB-master/CELAB3/24_StateSpace_LQR/2.4.1_2_2.5_6SymmetricRootLocus/realtimemodel_sldrt_win64$(WQ);$(WQ)$(MATLAB_ROOT)/extern/include$(WQ);$(WQ)$(MATLAB_ROOT)/simulink/include$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src/ext_mode/common$(WQ);$(WQ)$(MATLAB_ROOT)/toolbox/coder/rtiostream/src$(WQ)
