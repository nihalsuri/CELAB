 ...
 * C source code generated on : Fri May 16 12:22:41 2025
 *
...
typedef struct {
  ...
  real_T HiddenBuf_InsertedFor_FeedbackControllerRobust_at_inport_2;/* '<Root>/Step' */
  real_T Integralgain1;                /* '<S2>/Integral gain1' */
...
typedef struct {
  ...
  int8_T FeedbackControllerRobust_SubsysRanBC;
                                      /* '<Root>/Feedback Controller  Robust' */
  int8_T Average_SubsysRanBC;          /* '<S5>/Average' */
  boolean_T FeedbackControllerRobust_MODE;
                                      /* '<Root>/Feedback Controller  Robust' */
...
struct P_realtimemodel_T_ {
  struct_Q2ZTlX4ahwdHGelGEg2HrB feedback;/* Variable: feedback
                                          * Referenced by:
  ...
  struct_4jr0aBoeUcVnCi5PWU4anE sens;  /* Variable: sens
                                        ...
                                        *   '<S1>/V2Deg1'
                                        */
  struct_1Cgd91v4lvavj0utfCE0CB sIn;   /* Variable: sIn
                                        * Referenced by:
                                        *   '<Root>/Step'
                                        *   '<Root>/Step1'
                                        *   '<S7>/Lower Limit'
 ...
 * '<S2>'   : 'realtimemodel/Feedback Controller  Robust'
