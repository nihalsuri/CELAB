...
void realtimemodel_output(void)
{
  ...
  /* Outputs for Enabled SubSystem: '<Root>/Feedback Controller  Robust' incorporates:
  ...
  /* End of Outputs for SubSystem: '<Root>/Feedback Controller  Robust' */
  if (tmp) {
...
void realtimemodel_derivatives(void)
{
  ...
  /* Derivatives for Enabled SubSystem: '<Root>/Feedback Controller  Robust' */
  if (realtimemodel_DW.FeedbackControllerRobust_MODE) {
  ...
  /* End of Derivatives for SubSystem: '<Root>/Feedback Controller  Robust' */
}
...
void realtimemodel_initialize(void)
{
  ...
  /* Start for Enabled SubSystem: '<Root>/Feedback Controller  Robust' */
  realtimemodel_DW.FeedbackControllerRobust_MODE = false;
  (void) memset(&(realtimemodel_XDis.Integrator1_CSTATE), 1,
                1*sizeof(boolean_T));

  /* End of Start for SubSystem: '<Root>/Feedback Controller  Robust' */
  ...
  /* SystemInitialize for Enabled SubSystem: '<Root>/Feedback Controller  Robust' */
  ...
  /* End of SystemInitialize for SubSystem: '<Root>/Feedback Controller  Robust' */
}
...
RT_MODEL_realtimemodel_T *realtimemodel(void)
{
  ...
  /* External mode info */
  realtimemodel_M->Sizes.checksums[0] = (3909391486U);
  realtimemodel_M->Sizes.checksums[1] = (3366894913U);
  realtimemodel_M->Sizes.checksums[2] = (4245251650U);
  realtimemodel_M->Sizes.checksums[3] = (1754894798U);
  ...
  realtimemodel_M->Sizes.numBlocks = (33);/* Number of blocks */
