...
typedef struct {
  ...
  real_T th_ddeg;                      /* '<S1>/V2Deg1' */
  real_T Sum1;                         /* '<S1>/Sum1' */
  real_T PulseGenerator;               /* '<Root>/Pulse Generator' */
  real_T Step2;                        /* '<Root>/Step2' */
  real_T HiddenBuf_InsertedFor_FeedbackControllers_at_inport_2;/* '<Root>/Step2' */
  real_T deg2rad;                      /* '<S2>/deg2rad' */
  real_T InputfeedforwardgainNu;       /* '<S2>/Input feedforward gain (Nu)' */
  real_T x[4];                         /* '<S2>/deg2rad_1' */
  real_T Integralgain;                 /* '<S2>/Integral gain' */
  real_T StatefeedforwardgainNx[6];    /* '<S2>/State feedforward gain(Nx)' */
...
typedef struct {
  ...
  int8_T FeedbackControllers_SubsysRanBC;/* '<Root>/Feedback Controllers' */
  int8_T Average_SubsysRanBC;          /* '<S5>/Average' */
  boolean_T FeedbackControllers_MODE;  /* '<Root>/Feedback Controllers' */
  boolean_T Average_MODE;              /* '<S5>/Average' */
} DW_realtimemodel_T;

/* Continuous states (default storage) */
typedef struct {
  real_T Realderivative_CSTATE[2];     /* '<S3>/Real derivative' */
...
/* State disabled  */
typedef struct {
  boolean_T Realderivative_CSTATE[2];  /* '<S3>/Real derivative' */
...
struct P_realtimemodel_T_ {
  struct_XgiRYHkMfsPjdM8Rg78U0F LQR;   /* Variable: LQR
                                        * Referenced by: '<S2>/State-Space'
                                        */
  struct_qHcXdWcs7KAyuA40bFEwnC feedback;/* Variable: feedback
                                          * Referenced by:
  ...
  struct_4jr0aBoeUcVnCi5PWU4anE sens;  /* Variable: sens
                                        ...
                                        *   '<S1>/V2Deg1'
                                        */
  struct_RrN3B6TGuHXuTo2ke8b2GF sIn;   /* Variable: sIn
                                        * Referenced by:
                                        *   '<Root>/Step2'
  ...
  real_T Integrator_IC;                /* Expression: 0
                                        ...
                                        */
  real_T StateSpace_C[4];              /* Expression: eye(2,2)
                                        * Referenced by: '<S2>/State-Space'
                                        */
  ...
  real_T PulseGenerator_PhaseDelay;    /* Expression: 0
                                        * Referenced by: '<Root>/Pulse Generator'
                                        */
  real_T Realderivative_A[2];          /* Computed Parameter: Realderivative_A
                                        * Referenced by: '<S3>/Real derivative'
                                        */
  real_T Realderivative_C[2];          /* Computed Parameter: Realderivative_C
                                        * Referenced by: '<S3>/Real derivative'
                                        */
 ...
 *
 * '<Root>' : 'realtimemodel'
 * '<S1>'   : 'realtimemodel/Beam displacement Sensing'
 * '<S2>'   : 'realtimemodel/Feedback Controllers'
 * '<S3>'   : 'realtimemodel/Simple Observer'
 * '<S4>'   : 'realtimemodel/Subsystem'
 * '<S5>'   : 'realtimemodel/Beam displacement Sensing/Bias Estimation'
 * '<S6>'   : 'realtimemodel/Beam displacement Sensing/Bias Estimation/Average'
 * '<S7>'   : 'realtimemodel/Beam displacement Sensing/Bias Estimation/Interval Test'
 */
