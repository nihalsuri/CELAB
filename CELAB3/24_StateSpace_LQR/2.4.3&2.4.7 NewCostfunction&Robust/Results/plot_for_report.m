...
p.simout = [LQRbryson];  % Replace with your actual Simulink output variables
p.save_name = "Bryson_nominal_motor";
p.time_start = 0;
p.time_stop  = 2;
% =========================================================================
...
if ~exist('Clean Figures', 'dir')
    mkdir('Clean Figures');
end
filename = fullfile('Clean Figures\', [char(p.save_name), '.png']);
