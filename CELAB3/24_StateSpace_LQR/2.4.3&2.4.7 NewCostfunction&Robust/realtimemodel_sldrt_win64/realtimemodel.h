...
typedef struct {
  ...
  real_T Step;                         /* '<S2>/Step' */
  real_T HiddenBuf_InsertedFor_FeedbackController_at_inport_2;/* '<S2>/Step' */
...
typedef struct {
  ...
  int8_T FeedbackController_SubsysRanBC;/* '<S2>/Feedback Controller' */
  int8_T Average_SubsysRanBC;          /* '<S5>/Average' */
  boolean_T FeedbackControllerRobust_MODE;/* '<S2>/Feedback Controller Robust' */
  boolean_T FeedbackController_MODE;   /* '<S2>/Feedback Controller' */
...
struct P_realtimemodel_T_ {
  struct_4jr0aBoeUcVnCi5PWU4anE sens;  /* Variable: sens
                                        ...
                                        *   '<S1>/V2Deg1'
                                        */
  struct_PgmIS4SOnZBuutpNyb6QwH feedback;/* Variable: feedback
                                          * Referenced by:
 ...
 * '<S8>'   : 'realtimemodel/Feedback Controllers/Feedback Controller'
 * '<S9>'   : 'realtimemodel/Feedback Controllers/Feedback Controller Robust'
 */
