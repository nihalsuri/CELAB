...
typedef struct {
  ...
  real_T Abs;                          /* '<Root>/Abs' */
  real_T DiscreteTimeIntegrator;       /* '<S4>/Discrete-Time Integrator' */
} B_realtimemodel_T;
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } vartheta_ddeg_PWORK;               /* '<Root>/\vartheta_{d} [deg]' */
  ...
  int8_T Average_SubsysRanBC;          /* '<S3>/Average' */
  boolean_T Average_MODE;              /* '<S3>/Average' */
} DW_realtimemodel_T;
...
struct P_realtimemodel_T_ {
  struct_4jr0aBoeUcVnCi5PWU4anE sens;  /* Variable: sens
                                        ...
                                        */
  struct_PsxgvbRLes4DlOQfHx6iWC sIn;   /* Variable: sIn
                                        * Referenced by:
                                        *   '<S5>/Lower Limit'
                                        *   '<S5>/Upper Limit'
                                        */
 ...
 * '<S3>'   : 'realtimemodel/Beam displacement Sensing/Bias Estimation'
 * '<S4>'   : 'realtimemodel/Beam displacement Sensing/Bias Estimation/Average'
 * '<S5>'   : 'realtimemodel/Beam displacement Sensing/Bias Estimation/Interval Test'
 */
