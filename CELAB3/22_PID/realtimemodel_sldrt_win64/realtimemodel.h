...
typedef struct {
  void *EncoderInput_PWORK;            /* '<S2>/Encoder Input' */
...
struct P_realtimemodel_T_ {
  ...
  struct_920DhQDEUcX8rEEEFuNjn sIn;    /* Variable: sIn
                                        ...
                                        *   '<S1>/Constant'
                                        */
  struct_yckM6rUpEgOs9dzJhfmX6F PID;   /* Variable: PID
                                        * Referenced by:
                                        *   '<S3>/Gain'
                                        *   '<S3>/Gain1'
                                        *   '<S3>/Gain2'
 ...
 *
 * '<Root>' : 'realtimemodel'
 * '<S1>'   : 'realtimemodel/PID controller '
 * '<S2>'   : 'realtimemodel/Subsystem'
 * '<S3>'   : 'realtimemodel/PID controller /PID Controller with Anti Windup'
 * '<S4>'   : 'realtimemodel/PID controller /PID Standard Controller'
 * '<S5>'   : 'realtimemodel/PID controller /PID Controller with Anti Windup/Degrees to Radians'
 * '<S6>'   : 'realtimemodel/PID controller /PID Standard Controller/Degrees to Radians'
 */
